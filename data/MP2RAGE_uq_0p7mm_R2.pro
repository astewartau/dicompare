...
ulVersion	 = 	51280000
tSequenceFileName	 = 	"%CustomerSeq%\a_tfl_uq"
tProtocolName	 = 	"MP2RAGE_uq_0p75mm"
...
dAveragesDouble	 = 	1.0
lScanTimeSec	 = 	480
lTotalScanTimeSec	 = 	482
dRefSNR	 = 	67482.3189643
dRefSNR_VOI	 = 	67482.3189643
ucMotionCorr	 = 	1
ucCineMode	 = 	1
ucSequenceType	 = 	1
ucCoilCombineMode	 = 	1
...
sTXSPEC.aRFPULSE[0].flAmplitudeNL	 = 	453.965881348
sTXSPEC.aRFPULSE[1].flAmplitudeNL	 = 	62.0913925171
sTXSPEC.aRFPULSE[2].flAmplitudeNL	 = 	15.6780757904
sTXSPEC.aRFPULSE[3].flAmplitudeNL	 = 	31.3561515808
sTXSPEC.aRFPULSE[4].flAmplitudeNL	 = 	15.6780757904
...
sSliceArray.asSlice[0].dInPlaneRot	 = 	0.0975639051865
sSliceArray.asSlice[0].sPosition.dSag	 = 	1.32232003125e-011
sSliceArray.asSlice[0].sPosition.dCor	 = 	3.20001092404
sSliceArray.asSlice[0].sPosition.dTra	 = 	3.20001092403
sSliceArray.asSlice[0].sNormal.dSag	 = 	0.9998904999
sSliceArray.asSlice[0].sNormal.dCor	 = 	-0.009182019527
sSliceArray.asSlice[0].sNormal.dTra	 = 	0.01160511221
...
sAAInitialOffset.SliceInformation.dInPlaneRot	 = 	0.0975639051865
sAAInitialOffset.SliceInformation.sPosition.dSag	 = 	1.32232003125e-011
sAAInitialOffset.SliceInformation.sPosition.dCor	 = 	3.20001092404
sAAInitialOffset.SliceInformation.sPosition.dTra	 = 	3.20001092403
sAAInitialOffset.SliceInformation.sNormal.dSag	 = 	0.9998904999
sAAInitialOffset.SliceInformation.sNormal.dCor	 = 	-0.009182019527
sAAInitialOffset.SliceInformation.sNormal.dTra	 = 	0.01160511221
alRepetitionsDelayTimeMs.__attribute__.size	 = 	64
adFlipAngleDegree.__attribute__.size	 = 	32
adFlipAngleDegree[0]	 = 	5.0
adFlipAngleDegree[1]	 = 	3.0
aulServicePara.__attribute__.size	 = 	5
uiPerProxy2Skip.__attribute__.size	 = 	2
sCoilSelectMeas.dOverallImageScaleFactor	 = 	0.00777453838678
...
sWipMemBlock.alFree[2]	 = 	200
sWipMemBlock.alFree[5]	 = 	32
sWipMemBlock.alFree[17]	 = 	1
sWipMemBlock.alFree[18]	 = 	1
sWipMemBlock.alFree[25]	 = 	20
...
sWipMemBlock.adFree[1]	 = 	0.001
sWipMemBlock.adFree[3]	 = 	1.0
sWipMemBlock.adFree[4]	 = 	0.001
sWipMemBlock.adFree[5]	 = 	1.0
sWipMemBlock.adFree[6]	 = 	4.0
sWipMemBlock.adFree[7]	 = 	0.5
sWipMemBlock.adFree[8]	 = 	1.2
sWipMemBlock.adFree[9]	 = 	0.001
sWipMemBlock.adFree[10]	 = 	0.001
