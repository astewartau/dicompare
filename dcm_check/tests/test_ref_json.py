...
from dcm_check import load_ref_json, load_dicom, check_dicom_compliance, is_dicom_compliant, get_compliance_summaries_json
...
def test_json_compliance_within_tolerance_with_dcm(json_ref_with_dcm, dicom_test_file):
    ...
    compliance_summary = check_dicom_compliance(reference_model, t1_dicom_values)

    assert is_dicom_compliant(reference_model, t1_dicom_values)
